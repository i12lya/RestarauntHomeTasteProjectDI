...
namespace RestarauntHomeTaste.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClientsId,TablesId,DateReservatoion,HourReservation,GuestsCount,DateUpdate")] Reservation reservation)
        {
