...
{
    /// <inheritdoc />
    public partial class Ilya1234 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DishTypesId = table.Column<int>(type: "int", nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Dishes_DishTypes_DishTypesId",
                        column: x => x.DishTypesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Drinks_DrinkTypes_DrinkTypesId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateReservatoion = table.Column<DateTime>(type: "datetime2", nullable: false),
                    HourReservation = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dishes_DishTypesId",
                table: "Dishes",
                column: "DishTypesId");

            migrationBuilder.CreateIndex(
                name: "IX_Drinks_DrinkTypesId",
                table: "Drinks",
                column: "DrinkTypesId");
